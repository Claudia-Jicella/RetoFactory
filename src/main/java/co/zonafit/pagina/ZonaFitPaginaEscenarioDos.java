...
public class ZonaFitPaginaEscenarioDos extends AccionComunDeLaPagina {
    ...
    //Constructor
    public ZonaFitPaginaEscenarioDos(ZonaFitModel zonaFitModel, WebDriver webDriver) {
        super(webDriver);
    ...
    public static String validacionPagoEfecty(){return getText(validacionConvenio).trim();}
